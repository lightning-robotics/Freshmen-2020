...
public class TankDrive extends Command {
  ...
  protected void execute() {
    ...
    driverAxis = Math.min(Math.abs(driverAxis), varSpeed) * (driverAxis/driverAxis);
    driverAxis2 = Math.min(Math.abs(driverAxis2), varSpeed) * (driverAxis2/driverAxis2);
